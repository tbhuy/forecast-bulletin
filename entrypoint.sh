...
python3 /sparkinclimate/bin/dataset --out /sparkinclimate/dataset
python3 /sparkinclimate/bin/process --input /sparkinclimate/dataset --elasticsearch localhostdataset
